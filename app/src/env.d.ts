...
declare global {
  interface Window {
    lightterm: {
      ...
      sftpUpload: (payload: SSHConfig & { remoteDir?: string; localFile?: string; conflictPolicy?: 'overwrite' | 'resume' | 'skip' | 'rename'; resume?: boolean; remoteFileName?: string }) => Promise<{ ok: boolean; error?: string; localFile?: string; remoteFile?: string; remoteDir?: string; skipped?: boolean; resumedFrom?: number; folderMode?: boolean; uploadedFiles?: number; uploadedDirs?: number; empty?: boolean }>
